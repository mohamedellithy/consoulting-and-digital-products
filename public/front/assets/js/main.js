(function($) {
    ...
    /*=============================================
    	=            Header Search            =
    =============================================*/
    $("#subscrib_on_service").on('click', function() {
        $(".services-application-form").slideToggle();
        return false;
    });

    $(".services-application-form").on('click', '.services-application-close span', function() {
