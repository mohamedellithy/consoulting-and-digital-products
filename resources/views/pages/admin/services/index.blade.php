                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="badge bg-label-success me-1">مفعل</span> @else
                            <span class="badge bg-label-danger me-1">معطل</span> @endif
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('admin.services.edit', $service->id) }}"><i
                                        ...
                                        تعديل</a>
                                    <a class="dropdown-item" onClick="DeleteService()" data-service-id="{{ $service->id }}"><i
